...
for p in [0.4]:
	...
	for tr_l in [0.15, 0.2, 0.3]:

		print("DBG: " + str(tr_l))
		aleth_arc.initialize_architecture(model_file = "ase_model_bigger.pymodel", project_name = "aleth", split_trace_sets = split_set, remake_dataset = remake,
